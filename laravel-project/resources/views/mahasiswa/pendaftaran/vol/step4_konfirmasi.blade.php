...
<body class="registration-body">
    ...
    <section class="progress-section">
        <div class="progress-container">
            ...
            <div class="progress-labels">
                <span class="progress-label">Data Pribadi</span><span class="progress-label">Pilih Event</span><span class="progress-label">Motivasi</span><span class="progress-label active">Konfirmasi</span>
            </div>
        </div>
    </section>
    <main class="registration-main">
        <div class="form-container">
            ...
            @endif
            <form action="{{ route('mahasiswa.vol.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                <div class="confirmation-summary">
                    <h3 class="summary-title">Ringkasan Pendaftaran Volunteer</h3>
                    <div class="summary-grid">
                        ...
                        <div class="summary-row"><div class="summary-item full-width"><label class="summary-label">Event</label><p class="summary-value">{{ $data['event_name'] ?? 'N/A' }}</p></div></div>
                        <div class="summary-row">
                            <div class="summary-item full-width">
                                <label class="summary-label">Pilihan Peran</label>
                                <div class="summary-tags">
                                    @if(!empty($data['role_1']))<span class="summary-tag">1: {{ $data['role_1'] }}</span>@endif
                                    @if(!empty($data['role_2']))<span class="summary-tag">2: {{ $data['role_2'] }}</span>@endif
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="agreement-section">
                    <div class="agreement-item"><input type="checkbox" name="agree-terms" id="agree-terms" class="agreement-checkbox" required><label for="agree-terms" class="agreement-label">Saya menyetujui syarat dan ketentuan pendaftaran <span class="required">*</span></label></div>
                    <div class="agreement-item"><input type="checkbox" name="agree-privacy" id="agree-privacy" class="agreement-checkbox" required><label for="agree-privacy" class="agreement-label">Saya menyetujui penggunaan data pribadi <span class="required">*</span></label></div>
                </div>
                ...
                <div class="form-actions">
                    <a href="{{ route('mahasiswa.vol.step3') }}" class="btn-previous"><i class="fas fa-arrow-left"></i> Sebelumnya</a>
