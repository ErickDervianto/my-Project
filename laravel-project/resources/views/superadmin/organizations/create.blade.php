...
<head>
    <meta charset="UTF-8">
    <title>Tambah Organisasi Baru</title>
    <link rel="stylesheet" href="{{ asset('css/style.css') }}">
</head>
<body class="registration-body">
    <main class="registration-main">
        <div class="form-container" style="max-width: 800px;">
            <div class="form-header"><h2 class="form-title">Tambah Organisasi Baru</h2></div>
            @if ($errors->any())
            ...
            @endif
            <form action="{{ route('superadmin.organizations.store') }}" method="POST" class="registration-form">
                @csrf
                ...
                <div class="form-grid">
                    <div class="form-group-registration">
                        ...
                        <select id="type" name="type" class="form-select-registration" required>
                            ...
                            <option value="Universitas" @if(old('type') == 'Universitas') selected @endif>Universitas</option>
                            <option value="Fakultas" @if(old('type') == 'Fakultas') selected @endif>Fakultas</option>
                            <option value="Prodi" @if(old('type') == 'Prodi') selected @endif>Program Studi</option>
                        </select>
                    </div>
                    <div class="form-group-registration">
                ...
                <div class="form-group-registration">
                    ...
                    <input type="text" id="available_divisions" name="available_divisions" class="form-input-registration" value="{{ old('available_divisions') }}" placeholder="Contoh: Humas, Riset, Advokasi" required>
                </div>
                <div class="form-group-registration">
                ...
                <div class="form-actions">
                    ...
                    <button type="submit" class="btn-next">Simpan Organisasi</button>
                </div>
            </form>
        </div>
    </main>
